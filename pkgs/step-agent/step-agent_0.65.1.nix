...
let
  ...
  shaMap = {
    x86_64-linux = "1la9c24f581gb915npcbcgq2bdlc6vl1c8dxdsjjjwvvj9sjl8v8";
    aarch64-linux = "0z51lzya4mz5rb99wmj5p8zki5s2r5w2hbn9hn7fs12xgadwdwx2";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.1/step-agent_0.65.1_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.1/step-agent_0.65.1_linux_arm64.tar.gz";
  };
in
