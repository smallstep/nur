...
let
  ...
  shaMap = {
    x86_64-linux = "16wzkf6lx318y5wrh1g2wm2q7wnb7yqhvbg103xyz8qhnjbnshxw";
    aarch64-linux = "0zx5l7gdwp71ch8k9ipnz2sr9v3xhva93n608gh0p1srzinc0zcz";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc1/step-agent_0.67.4-rc1_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc1/step-agent_0.67.4-rc1_linux_arm64.tar.gz";
  };
in
