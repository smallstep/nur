...
let
  ...
  shaMap = {
    x86_64-linux = "0krfg362pc5jac04hgjigbccxy6wp1bb2gp99b6laml1kldr0k5x";
    aarch64-linux = "0awgzm9jy8xvdc2wismv0va2qgpv8fnz47k23v4qwbc6ydwvg3b9";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.3-rc3/step-agent_0.67.3-rc3_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.3-rc3/step-agent_0.67.3-rc3_linux_arm64.tar.gz";
  };
in
