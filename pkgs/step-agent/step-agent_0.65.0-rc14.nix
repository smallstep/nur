...
let
  ...
  shaMap = {
    x86_64-linux = "1647cyw1a95pq3qkmi81zcb05jj2am026jvq5yipjch7v059cl70";
    aarch64-linux = "04hb6990yjz6f283hd53ym8xdphxwk9l8pzkal880j7kxr7qn5d7";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0-rc14/step-agent_0.65.0-rc14_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0-rc14/step-agent_0.65.0-rc14_linux_arm64.tar.gz";
  };
in
