...
let
  ...
  shaMap = {
    x86_64-linux = "1713s7zsx2lci6jq2yb6spv4chl41yip9r8x691ssm91psxy5d2d";
    aarch64-linux = "1lnymlxkzh36hw6vijyw4bf8krmy66wwvdxnp243h9x4rxr8jacx";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc7/step-agent_0.67.4-rc7_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc7/step-agent_0.67.4-rc7_linux_arm64.tar.gz";
  };
in
