...
let
  ...
  shaMap = {
    x86_64-linux = "075cznw13bq159zz0ddfn8zk9xgg33j74yjs16wb0yaxc2gigr6y";
    aarch64-linux = "0h342n7028w8rxx0jad72g6qbdg234009myycyqjgfn6c8lw9x33";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc10/step-agent_0.67.4-rc10_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc10/step-agent_0.67.4-rc10_linux_arm64.tar.gz";
  };
in
