...
let
  ...
  shaMap = {
    x86_64-linux = "1a630p79r8scrd1qxzhp2z0mjijzx2ag2zk21i2ca4piizl23n42";
    aarch64-linux = "1dhwkx1qgqkj2gj8p8163j5svy4iif47kabp3b5bkawl5wghszb7";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.0/step-agent_0.67.0_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.0/step-agent_0.67.0_linux_arm64.tar.gz";
  };
in
