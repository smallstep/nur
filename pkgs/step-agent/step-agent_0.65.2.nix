...
let
  ...
  shaMap = {
    x86_64-linux = "127na2x69rg3f24yjz8g231hfv2k4mbwxh771b0qbsv7ymmn0pmq";
    aarch64-linux = "0z3zs2brxikynm4xayxv01b04pg81npc0jyklc1ly9wqhc32kbcs";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.2/step-agent_0.65.2_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.2/step-agent_0.65.2_linux_arm64.tar.gz";
  };
in
