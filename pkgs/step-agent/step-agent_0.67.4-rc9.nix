...
let
  ...
  shaMap = {
    x86_64-linux = "1ydl29sf6b8ldsgymg83ydi628wfs9xhpp13zipd0rkhpfl6gn9d";
    aarch64-linux = "1pnhg1d5hnlnzbz64r9ga0dwa22r01iyl33ws011z38i8kn1gc70";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc9/step-agent_0.67.4-rc9_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc9/step-agent_0.67.4-rc9_linux_arm64.tar.gz";
  };
in
