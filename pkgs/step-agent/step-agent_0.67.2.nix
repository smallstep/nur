...
let
  ...
  shaMap = {
    x86_64-linux = "1km5ha76p47qwlvw50s1vwczlpl3syy0xsx5k7ci6qf2nh2ylj1z";
    aarch64-linux = "1qxrni1kbva9h5z6ima72r5s7kgi44hhdx00mg25zwhy9rfygw9v";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.2/step-agent_0.67.2_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.2/step-agent_0.67.2_linux_arm64.tar.gz";
  };
in
