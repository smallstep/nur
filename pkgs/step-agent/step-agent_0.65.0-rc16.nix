...
let
  ...
  shaMap = {
    x86_64-linux = "0pd8gzb7z3x1pyvj7a6mnn56x2n60hl6a1yf41bg5hc8jpjaiw6c";
    aarch64-linux = "1xlrmdiaqg8ama5hdk4z0vm93dvvs68b10jm2sq0ici2r3y33anc";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0-rc16/step-agent_0.65.0-rc16_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0-rc16/step-agent_0.65.0-rc16_linux_arm64.tar.gz";
  };
in
