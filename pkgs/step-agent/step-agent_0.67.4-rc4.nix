...
let
  ...
  shaMap = {
    x86_64-linux = "1f3i1j7k43wr1cgcbl3rcjyzixq5bykm9xgwrw9a2galpynhq3dx";
    aarch64-linux = "1pd1cm0h7fkq8s8wxmkd7vvj1znymyxsp21sws3f2zhd0635i774";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc4/step-agent_0.67.4-rc4_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc4/step-agent_0.67.4-rc4_linux_arm64.tar.gz";
  };
in
