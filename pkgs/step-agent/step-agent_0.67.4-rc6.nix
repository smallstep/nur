...
let
  ...
  shaMap = {
    x86_64-linux = "0r5p1p78qb0v5mr9cbgpb2h6j2062ijsq261i2rpsqswgzpphvg4";
    aarch64-linux = "1w0iwsnmcgsm5ksjlnni6w6jimif5j634i6k2jkyg0va5p6ascb0";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc6/step-agent_0.67.4-rc6_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc6/step-agent_0.67.4-rc6_linux_arm64.tar.gz";
  };
in
