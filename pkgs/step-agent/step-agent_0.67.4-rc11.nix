...
let
  ...
  shaMap = {
    x86_64-linux = "1qc2dr0g38nqpn6y3aszafh49yn2p5r2j6vgiis7zyh12fz8j54n";
    aarch64-linux = "1b2w1c034qy0py7cf3a6hdw6vmpdxcmhj95rf2l626rvngdh6zxm";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc11/step-agent_0.67.4-rc11_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc11/step-agent_0.67.4-rc11_linux_arm64.tar.gz";
  };
in
