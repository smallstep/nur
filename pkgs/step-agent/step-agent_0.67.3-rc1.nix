...
let
  ...
  shaMap = {
    x86_64-linux = "1y4fivh6wm69kvpqygd9dnypvs7mk33xqs3rc2lmk1yqb4dw0pkc";
    aarch64-linux = "03s2kab5pkc3dm8g6ccsmk6vxpa9ihrc081fwj6nvch9y32mhq7n";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.3-rc1/step-agent_0.67.3-rc1_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.3-rc1/step-agent_0.67.3-rc1_linux_arm64.tar.gz";
  };
in
