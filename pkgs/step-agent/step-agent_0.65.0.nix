...
let
  ...
  shaMap = {
    x86_64-linux = "03wjjxlvrkcx9wmb8kfl1lan5hv0y7d1nn0id8wwd07yqljhvcmn";
    aarch64-linux = "0hb5r37fhf0298wsbh0i11yvznnbxv4aivjz9wr7k2mjgfav08cw";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0/step-agent_0.65.0_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0/step-agent_0.65.0_linux_arm64.tar.gz";
  };
in
