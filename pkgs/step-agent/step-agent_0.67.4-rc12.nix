...
let
  ...
  shaMap = {
    x86_64-linux = "106a2fbgj2j6dgwddpg89rqghyvkjfysj8khnh1y2d3g33k1ifi3";
    aarch64-linux = "1vm3c4r2shls4khvxy4gqa0lcaqdc8qqihbk6f6937nd1wryn2a8";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc12/step-agent_0.67.4-rc12_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc12/step-agent_0.67.4-rc12_linux_arm64.tar.gz";
  };
in
