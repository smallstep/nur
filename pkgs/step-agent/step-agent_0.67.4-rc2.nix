...
let
  ...
  shaMap = {
    x86_64-linux = "1h7p6kfq1jqx4xm60sawyidkk2drmb4fzh4g3ks6xv880l8dykz7";
    aarch64-linux = "0in9y5wmi62rh4vjiid7bwglyn0jd5ys3mrm4cwvb6cjb6xznarf";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc2/step-agent_0.67.4-rc2_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc2/step-agent_0.67.4-rc2_linux_arm64.tar.gz";
  };
in
