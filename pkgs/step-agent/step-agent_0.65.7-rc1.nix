...
let
  ...
  shaMap = {
    x86_64-linux = "1xcf5rdmvrbgyzki0wvi2h5p8gpmchij3m6vp306p9nvjkrjmcs3";
    aarch64-linux = "0cx8j7fc23xbxw9z6mxp9as2iaxnvb56arnqihd0yc2xf6a9ma69";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.7-rc1/step-agent_0.65.7-rc1_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.7-rc1/step-agent_0.65.7-rc1_linux_arm64.tar.gz";
  };
in
