...
let
  ...
  shaMap = {
    x86_64-linux = "0fvdk3yz3lx4gv7gbbj8nspywrm6fm1z7hyjqxln309p0wn3kdwq";
    aarch64-linux = "1as73q31dwzq3rf1rf7hl7lqckds16i1zfjm90bypm81rnl9zihk";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.4/step-agent_0.65.4_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.4/step-agent_0.65.4_linux_arm64.tar.gz";
  };
in
