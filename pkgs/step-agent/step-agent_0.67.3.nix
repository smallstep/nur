...
let
  ...
  shaMap = {
    x86_64-linux = "14rlpplad5237434fkv5gzrdnnmbm6h50kk43nb00izjv1s7ldmi";
    aarch64-linux = "1fc6zsh29dsqp1vryqx9qwhc6cfdp3j5mgkbx0qiz7wprywrymyi";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.3/step-agent_0.67.3_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.3/step-agent_0.67.3_linux_arm64.tar.gz";
  };
in
