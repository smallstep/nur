...
let
  ...
  shaMap = {
    x86_64-linux = "18acw115382yy104xfmynn9hb08ij494pingz0w7qyifaz2npa1s";
    aarch64-linux = "0qs6q8qb18c21lnmdmrz5jyajzv1rv5c1hvymgkxbrwxyh840dxw";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc8/step-agent_0.67.4-rc8_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.4-rc8/step-agent_0.67.4-rc8_linux_arm64.tar.gz";
  };
in
