...
let
  ...
  shaMap = {
    x86_64-linux = "1iv75cdk7xjcfplqmh8sr7jmz10zva287wn2p7m19adnv9kjwyj7";
    aarch64-linux = "019mj506njck68n34hy03f4g2l54nnqg9m3n5v52s6qdb8gzrkj1";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.3-rc2/step-agent_0.67.3-rc2_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.67.3-rc2/step-agent_0.67.3-rc2_linux_arm64.tar.gz";
  };
in
