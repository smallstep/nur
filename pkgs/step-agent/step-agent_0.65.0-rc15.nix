...
let
  ...
  shaMap = {
    x86_64-linux = "1jp1kqswwr5v2iamnamqbzay1sfs4520151v2dd19908lgxs9ws0";
    aarch64-linux = "03vqpzfmnjkkafrqw9fk1cxsgaya6r2nc2g82p626w6ha4rp9rgq";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0-rc15/step-agent_0.65.0-rc15_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0-rc15/step-agent_0.65.0-rc15_linux_arm64.tar.gz";
  };
in
