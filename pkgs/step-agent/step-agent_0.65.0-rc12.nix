...
let
  ...
  shaMap = {
    x86_64-linux = "003bcmfgz87khg39x1jcxy5psgm00yy5y8n08r3rksmmi8hy5spg";
    aarch64-linux = "1wm3n973pq38z096d6d3kl081riqp7n36bczfln9676n1yxrkalp";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0-rc12/step-agent_0.65.0-rc12_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0-rc12/step-agent_0.65.0-rc12_linux_arm64.tar.gz";
  };
in
