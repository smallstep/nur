...
let
  ...
  shaMap = {
    x86_64-linux = "0a2hvvnp3zvn6d9z4jn9r0il5cswq9g9qi3p298xld6880lb0jgz";
    aarch64-linux = "1si1nsd2g34ml6c71zlj9hk0q2sypmsk4f9xf118p4hq8gcz423j";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/agent/releases/download/v0.0.0-nightly.20260327/step-agent_0.0.0-nightly.20260327_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/agent/releases/download/v0.0.0-nightly.20260327/step-agent_0.0.0-nightly.20260327_linux_arm64.tar.gz";
  };
in
stdenvNoCC.mkDerivation {
  pname = "step-agent-plugin";
  version = "0.0.0-nightly.20260327";
  src = fetchurl {
    url = urlMap.${system};
