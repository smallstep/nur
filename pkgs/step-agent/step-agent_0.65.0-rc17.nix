...
let
  ...
  shaMap = {
    x86_64-linux = "190gjk23lnjq8nak50yhlmlq81j9drf9j2va4a7kpaa7mbwwbv7b";
    aarch64-linux = "1mjzcifg2filxhji7d45k3v6c9scmvwvx4vkvmyxfxp2fylfpd16";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0-rc17/step-agent_0.65.0-rc17_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.65.0-rc17/step-agent_0.65.0-rc17_linux_arm64.tar.gz";
  };
in
