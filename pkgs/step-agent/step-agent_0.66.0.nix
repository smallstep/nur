...
let
  ...
  shaMap = {
    x86_64-linux = "1scm4nisxiqf1z19wsnim1s3nvm7hbr54sx3g1zpbzwx91mx16dr";
    aarch64-linux = "0lvjbi26l3fkw9xxzldi8w78a80q28rfwcbcqzc4bw6d69sagb8b";
  };

  urlMap = {
    x86_64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.66.0/step-agent_0.66.0_linux_amd64.tar.gz";
    aarch64-linux = "https://github.com/smallstep/step-agent-plugin/releases/download/v0.66.0/step-agent_0.66.0_linux_arm64.tar.gz";
  };
in
